...
-->
      ...
      <section id="install">
        ...
        * Mac OS X only: To run iOS apps in the simulator or on a device you will need Xcode 4.5.2 installed
        ...
        <p><a href="http://download.robovm.org/robovm-{{site.robovm.version}}.tar.gz">Download the latest RoboVM release</a> or use a package built by following the instructions in the <a href="#build">Build</a> section below.</p>
