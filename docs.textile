...
-->
      ...
      <section id="install">
        ...
        * Mac OS X only: To run iOS apps in the simulator or on a device you will need Xcode 4.5.2 installed
        ...
        <p><a href="http://download.robovm.org/robovm-{{site.robovm.version}}.tar.gz">Download the latest RoboVM release</a> or use a package built by following the <a href="#build">build instructions</a> in the section below.</p>
