    ...
    <div class="span9">
      ...
      <section id="getting-started">
        ...
        * Mac OS X only: To run iOS apps in the simulator or on a device you will need Xcode 4.5.2 installed
        ...
        <p>
          You should now have a folder called <code>HelloWorld</code> with a 
          <code>HelloWorld</code> in it. Running <code>HelloWorld/HelloWorld</code> 
          should print:</p>
        <pre>
          Hello world!
        </pre>
        ...
        <p>
          ...
          current system (either Linux or Mac OS X). The jar files in 
